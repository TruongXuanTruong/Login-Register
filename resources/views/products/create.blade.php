...
@section('contents')
    <h1 class="font-bold text-2xl ml-3">Thêm Sản Phẩm</h1>
    <hr />
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <form action="{{ route('admin/products/store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <textarea name="description" placeholder="Mô tả sản phẩm" rows="3"
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <select id="type_products" name="type_products"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <button type="submit"
                    class="flex w-full justify-center mt-10 rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Hoàn
                    Thành</button>
            </form>
        </div>
    </div>
